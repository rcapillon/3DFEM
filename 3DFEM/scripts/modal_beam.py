...
beam_solver = solver.Solver(beam_structure)
...
beam_solver.modal_solver(n_modes)
...
file_name = "./animation_modal_beam"
scale = 5e-1
fun.export_mode_animation(file_name, beam_solver, index_mode, scale, n_frames)
