...
beam_solver.linear_diagonal_newmark_solver(beta1, beta2, vec_t, n_modes, verbose=False)
...
file_name_plot = "./U_DOF"
fun.plot_observed_U(file_name_plot, beam_solver, x_name="Time (s)", y_name="Displacement (m)", plot_type="linear")

file_name = "./animation_time_beam"
scale = 1e0
fun.export_U_newmark_animation(file_name, beam_solver, scale)
