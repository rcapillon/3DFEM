...
##############################################################################
# Stochastic time-domain analysis of a beam
##############################################################################
...
plate_solver.linear_newmark_solver_UQ(beta1, beta2, vec_t, n_modes, n_samples, delta_M, delta_K,\
...
file_name_plot = "./UQ_timedomain_beam_plot"

confidence_level = 0.95

fun.plot_random_observed_U(file_name_plot, plate_solver, confidence_level,\
