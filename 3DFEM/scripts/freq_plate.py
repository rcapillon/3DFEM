...
file_name_frf = "./frf_DOF"
fun.plot_observed_U(file_name_frf, plate_solver, x_name="Frequency (Hz)", y_name="Displacement amplitude (m)", plot_type="semilogy")

observed_frequency_1 = 16660
num_step = round(n_freqsteps * (observed_frequency_1 - f0) / (fmax - f0))

vec_U_step = plate_solver.get_vec_absU_step(num_step)

file_name_deformedmesh0 = "./freq_plate_16660Hz"
scale = 2e9
fun.export_U_on_mesh(file_name_deformedmesh0, plate_mesh, vec_U_step, scale)
