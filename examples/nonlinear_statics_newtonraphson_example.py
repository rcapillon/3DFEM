...
beam_solver = NonlinearStaticsNewtonRaphsonSolver(beam_structure, neumann_BC=neumann_BC)

lambda_max = 7000
n_load_increments = 10
n_iter_max = 20
tol = 1e-9
...
beam_solver.run(lambda_max=lambda_max, n_load_increments=n_load_increments, n_iter_max=n_iter_max, tol=tol,
                verbose=True)
...
file_name_plot = "plot_nonlinear_statics_newtonraphson_example_"
...
file_name_norm = "plot_norm_U_nonlinear_statics_newtonraphson_example_"
plot_norm_U_load_displacement(file_name_norm, beam_solver,
                              x_name="Displacement (m)", y_name="Load factor", plot_type="linear")

file_name_norm_animation = "animation_norm_U_nonlinear_statics_newtonraphson_example_"
stepsize = 1
plot_norm_U_load_displacement_animation(file_name_norm_animation, beam_solver, stepsize, fps=2)

file_name_animation = "animation_nonlinear_statics_newtonraphson_example_"
scale = 1e0
